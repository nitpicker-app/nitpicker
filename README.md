...
Nitpicker stores your API key locally in the Keychain (not UserDefaults) and only sends the selected text to OpenAI's API for correction. No other data is collected or transmitted.
